    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- Topbar Search -->
                <div><h5>Każda chwila jest dobra, żeby coś przekąsić...</h5></div>
            ...
            <div class="container-fluid">
                ...
                <c:if test="${param.AccountDelete != null}">
                        ...
                        <div class="card border-left-info shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><a class="nav-link" href="RegistrationForm">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><a class="nav-link" href="About">
                                            <span>O aplikacji</span></a></div>
                                    </div>
                                    <div class="col-auto">
                ...
                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="" src="img/jak-prawidlowo-jesc-wloskie-jedzenie-wazne-zasady-2331588.jpg" alt="">
            </div>
<br>
        <!-- Footer -->
