    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h5>Podaj Swoje składniki, z których coś zrobimy.</h5>
                <br>
                <form action="/FoodIngredients${userId}" method="post" role="form"  >
                    <input type="text" name="firstIngredient" id="firstIngredient" placeholder="Pierwszy składnik ">
                    <input type="text" name="secondIngredient" id="secondIngredient" placeholder="Drugi składnik ">
                    <input type="text" name="thirdIngredient" id="thirdIngredient" placeholder="Trzeci składnik ">

                    <input type="submit" value="Szukaj" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"></input> *Składniki muszą być podawane w języku angielskim
                </form>
